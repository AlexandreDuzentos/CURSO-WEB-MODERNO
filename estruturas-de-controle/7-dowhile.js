/**
 * do while é uma estrutura de controle que repete um bloco de comandos enquanto uma condição for 
 * verdadeira
 * 
 * A particularidade do do while em relação ao while é que o bloco de comandos é executado pelo menos
 * uma vez, antes da condição ser testada
 * 
